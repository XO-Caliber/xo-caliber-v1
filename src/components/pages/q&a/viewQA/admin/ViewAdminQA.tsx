  ...
  const { mutate: deleteAdminQuestion } = trpc.question.adminQuestionDelete.useMutation({
    onSuccess({ success }) {
      if (success) {
        ...
        router.refresh();
        toast({
          title: "Succesfully deleted the question"
        });
      }
    },
    onError(err) {
              ...
              <section className="absolute   m-16 mt-44  rounded-lg border-2 bg-white  shadow-lg">
                <ul className="p-8 text-left  text-base">
                  <li className="font-serif text-lg">
                    ...
                    applications such as EB1A, EB2 NIW and O1 visas. It&apos;s crucial to understand
                    that these questions serve as a tool for profiling and narrative building.
                    Importantly, the results/outcome of the exercise do not determine your
                    ...
                    team has formulated the questions based on expert opinions and a wealth of
                    acquired knowledge. A compartmentalized approach, coupled with a detailed
                    understanding of immigration crriteria, and a strategic method in approaching
                    the eligitble criteria, facilitates a more informed immigration strategy. By
                    breaking down the process into distinct compartments, each criteria can be
                    systematically addressed, ensuring a comprehensive evaluation of your
                    professional situation. Some questions may appear similar, but they are designed
                    to elicit different responses to better assess and enhance your profile
                    understanding. This approach enables a thorough examination of the immigration
                    criteria, allowing for a strategic and well-informed approach tailored to your
                    specific needs. Whether it involves documentation, eligibility criteria, or
                    procedural steps, this methodical strategy enhances the overall effectiveness of
                  ...
                  <li className="mt-8 flex rounded-lg border bg-secondary p-2 py-6 ">
                    ...
                    <div className="grid gap-1.5 pl-2 leading-none">
                      ...
                      >
                        ...
                        are enrolled to be managed under Firm (or) you need a deeper understanding
                        of each question to grasp the specific requirements of each compartment
                        before providing your response. In order for the evaluation process to be
                        effective, accurate and reliable information must be provided. Even though
                        the answer choices are binary, we sincerely request that you dedicate ample
                        time—perhaps hours or days—to research or contemplate each question. We
                        encourage you to revisit the questions periodically as you advance on your
                        immigration journey. Please accept sincere thanks and best wishes for your
                        future endeavors on behalf of XO Caliber team.
                      </label>
                    </div>
                  </li>
                </ul>
