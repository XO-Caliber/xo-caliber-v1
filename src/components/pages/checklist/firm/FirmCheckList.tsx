...
const FirmCheckList = () => {
  ...
  const newSubHeadingInputRefs: { [key: string]: React.RefObject<HTMLInputElement> } = {};
  const newChecklistInputRefs: { [key: string]: React.RefObject<HTMLInputElement> } = {};
    ...
    <div>
      ...
      <div className="h-[91vh] p-2">
        {checkListData.data ? (
          ...
          <div>
            {checkListData && (checkListData.isFetching || checkListData.isRefetching) ? (
